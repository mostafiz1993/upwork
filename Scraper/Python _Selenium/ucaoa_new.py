...
def generate_csv1(name,employername,phoneNo,website,writer):
    try:
        writer.writerow({'name' : name , 'employer' : employername,'PhoneNo' : phoneNo,'Website' : website})
    except:
        print ('csv write problem')
...
# fieldnames = ['name','employer','PhoneNo','Website']
# csvF = csv_file_name_generation('ucaoa.csv')
# writer = csv.DictWriter(csvF, fieldnames=fieldnames)
# writer.writeheader()
# path_to_chromedriver = '/home/mostafiz/Downloads/chrome1/chromedriver'  # change path as needed
...
parser('http://ucaoa.site-ym.com/searchserver/people.aspx?id=C1F78984-1405-486C-99C4-9DE612124B80&cdbid=&canconnect=0&canmessage=0&map=False&toggle=True&hhSearchTerms=')
